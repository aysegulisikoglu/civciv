...
{
    [SerializeField] private Animator _playerAnimator; // Animator bileşeni referansı

    private PlayerController _playerController; // PlayerController referansı
    private StateController _stateController; // StateController referansı
    ...
    private void PlayerController_OnPlayerJumped()
    {
        ...
        Invoke(nameof(ResetJumping), 0.5f); // Zıplama animasyonunu kısa süre sonra sıfırlar
    }
